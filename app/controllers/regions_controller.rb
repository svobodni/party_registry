class RegionsController < ApplicationController
  ...
  before_action :set_region, only: [:show, :branches, :mestske_casti, :okresy, :map, :awaiting_domestic_people, :domestic_members, :domestic_supporters, :guest_people, :unpaid_domestic_members]
