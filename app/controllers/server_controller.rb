...
class ServerController < ApplicationController
  ...
  before_action :authenticate_person!, except: :user_page
...
EOS
  ...
  def is_authorized(identity_url, trust_root)
    return (current_person and (identity_url == url_for_user) and self.approved(trust_root))
  end
...
EOS
  ...
  def add_sreg(oidreq, oidresp)
    ...
    # it.
    sreg_data = {
      'nickname' => current_person.username,
      'fullname' => current_person.name,
